...
const Canada = () => {
  ...
  const fetchAus = async () => {
    const res = await api.get("/study-aus");
  ...
  console.log(getData, "suman dulal");
  ...
  return (
    <>
      ...
      >
        {" "}
        <h1 className=" absolute top-[50%] sm:left-[10%] z-30 translate-x-[] text-white-200 lg:font-medium text-[41px] ">
          Study In Australia
        </h1>
        <div className=" z-2 bg-overlay absolute top-0 left-0 w-full h-full"></div>
      </div>
      <div className=" container mx-auto ">
        <div className=" px-2 sm:flex  lg:px-0 gap-10 mt-10">
          <div
